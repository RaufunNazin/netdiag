...
const UserStatus = () => {
  ...
  return (
    <>
      <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20 items-center p-2 rounded-lg bg-slate-100/10 hidden md:flex">
      ...
      <div className="absolute bottom-16 left-2 z-20 flex items-center md:hidden rounded-lg bg-slate-100/10">
        <button
          onClick={() => setIsModalOpen(true)}
